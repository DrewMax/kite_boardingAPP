# Welcome to the kiteboarding app #

## Description ##

A kitboarding app that displays the best location to kiteboard depending on the time of the year.
...
- GIVEN that I want to travel in different times of the year
- WHEN I load the page
- THEN I am presented with every month of the year and map to display locations.
- WHEN I click on a specific month my choices
- THEN a map with the best locations for that month is displayed
- WHEN I click on a specific location on the map
